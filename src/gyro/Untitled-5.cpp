...
//   Serial.println(F(""));
  ...
  // gyro_buffer[0] = gyro_x & 255;
  // gyro_buffer[1] = (gyro_x >> 8) & 255;
  // gyro_buffer[2] = gyro_y & 255;
  // gyro_buffer[3] = (gyro_y >> 8) & 255;
  // gyro_buffer[4] = gyro_z & 255;
  // gyro_buffer[5] = (gyro_z >> 8) & 255;
  
  // gyro_buffer[0] = angle_x;
  // gyro_buffer[1] = (angle_x >> 8) & 255;
  // gyro_buffer[2] = (angle_x >> 16) & 255;
  // gyro_buffer[3] = (angle_x >> 24) & 255;
  // gyro_buffer[4] = angle_y & 255;
  // gyro_buffer[5] = (angle_y >> 8) & 255;
  // gyro_buffer[6] = (angle_y >> 16) & 255;
  // gyro_buffer[7] = (angle_y >> 24) & 255;
  // gyro_buffer[8] = angle_z;
  // gyro_buffer[9] = (angle_z >> 8) & 255;
  // gyro_buffer[10] = (angle_z >> 16) & 255;
  // gyro_buffer[11] = (angle_z >> 24) & 255;
//   gyro_buffer[0] = (char*)&angle_x;
//   gyro_buffer[4] = (char*)&angle_y;
//   gyro_buffer[8] = (char*)&angle_z;


//   char *xptr = (char *)&gyro_angle_x;
//   char *yptr = (char *)&gyro_angle_y;
//   char *zptr = (char *)&gyro_angle_z;
  char *xptr = (char *)&angle_x;
  char *yptr = (char *)&angle_y;
  char *zptr = (char *)&angle_z;
//   char *xptr = (char *)&unfiltered_gyro_angle_x;
//   char *yptr = (char *)&unfiltered_gyro_angle_y;
//   char *zptr = (char *)&unfiltered_gyro_angle_z;

  Serial.write((char)170); // START BYTE (0b10101010)
  // //Serial.write((short)21845); // START BYTE ((0b10101010 << 8) + 0b01010101)
  //Serial.write(&gyro_buffer[0], sizeof(gyro_buffer));
  Serial.write(xptr, sizeof(float));
  Serial.write(yptr, sizeof(float));
  Serial.write(zptr, sizeof(float));
//   Serial.write((char)((angle_x & angle_y) ^ angle_z) & 255); // CRC
//   Serial.write((char)(((angle_x & angle_y) ^ angle_z) >> 8) & 255); // CRC
Serial.write((char)(xptr[1] + yptr[1] + zptr[1]) / 3);
